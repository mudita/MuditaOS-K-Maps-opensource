...
public class QuickSearchListItem {
	...
	public static Drawable getIcon(OsmandApplication app, SearchResult searchResult) {
		...
		switch (searchResult.objectType) {
			case CITY:
				...
				return town
						? getIcon(app, com.mudita.map.common.R.drawable.mx_mudita_default)
						: getIcon(app, com.mudita.map.common.R.drawable.mx_mudita_default);
			case VILLAGE:
				return getIcon(app, com.mudita.map.common.R.drawable.mx_mudita_default);
			case POSTCODE:
			case STREET:
	...
	public static int getCustomFilterIconRes(@Nullable PoiUIFilter filter) {
		...
		return iconId > 0 ? iconId : com.mudita.map.common.R.drawable.mx_mudita_default;
	}
}
