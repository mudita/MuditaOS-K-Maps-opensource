...
import net.osmand.plus.activities.OsmandBaseActivity;
...
public class BaseOsmAndFragment extends Fragment implements TransitionAnimator {
	...
	private boolean transitionAnimationAllowed = false;
	...
	@Nullable
	protected OsmandBaseActivity getInAppPurchaseActivity() {
		Activity activity = getActivity();
		if (activity instanceof OsmandBaseActivity) {
			return (OsmandBaseActivity) getActivity();
		} else {
			return null;
		}
	}
