...
import net.osmand.plus.mapcontextmenu.other.NetworkRouteDrawable;
...
public class TrackMenuFragment extends ContextMenuScrollFragment implements CardListener,
		...
		OsmAndCompassListener, OnSegmentSelectedListener,
	...
	public void onCardButtonPressed(@NonNull BaseCard card, int buttonIndex) {
		...
		if (card instanceof TrackPointsCard) {
	...
	public static void openTrack(@NonNull Context context, @Nullable File file, @Nullable Bundle prevIntentParams,
		...
		if (context instanceof MapActivity) {
			...
			MapActivity.Companion.launchMapActivityMoveToTop(context, prevIntentParams, null, bundle);
		}
	}
