...
public class RouteActivityType {
   ...
   public static RouteActivityType getOrCreateTypeFromName(String name) {
      ...
      return createType(name.toLowerCase(), "orange").icon("special_marker").reg();
   }

   private static RouteActivityType.RouteActivityTypeBuilder createType(String name, String color) {
      RouteActivityType.RouteActivityTypeBuilder builder = new RouteActivityType.RouteActivityTypeBuilder();
   ...
   public static RouteActivityType getTypeFromTags(String[] tags) {
      ...
      for(String tg : tags) {
         RouteActivityType rat = convertFromOsmGPXTag(tg);
         if (rat != null && (activityType == null || values.indexOf(activityType) > values.indexOf(rat))) {
            activityType = rat;
         }
      }
   ...
   public static RouteActivityType getTypeFromOSMTags(Map<String, String> tags) {
      ...
      return rt != null ? convertFromOsmGPXTag(rt) : null;
   }
   ...
   public static RouteActivityType convertFromOsmGPXTag(String tg) {
      ...
      if ("mountain hiking".equalsIgnoreCase(t)) {
         return HIKING;
      } else if ("motorcar".equalsIgnoreCase(t)) {
         return CAR;
      } else if ("laufen".equalsIgnoreCase(t)) {
         return RUNNING;
      } else if ("pedestrian".equalsIgnoreCase(t)) {
         return WALKING;
      } else {
         switch(t) {
            case "mountainbiking":
   ...
   public static class RouteActivityTypeBuilder {
      ...
      public RouteActivityType.RouteActivityTypeBuilder icon(String icon) {
         this.routeActivityType.icon = icon;
         return this;
      }
