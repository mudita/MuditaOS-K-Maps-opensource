...
public class Postcode {
   private static final Log log = PlatformUtil.getLog(Postcode.class);
   private static final Map<String, List<String>> rules = new TreeMap<>();
