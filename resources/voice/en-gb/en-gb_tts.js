...
function populateDictionary(tts) {
	...
	dictionary["and_arrive_favorite"] = tts ? "and pass favourite" : "and_arrive_favorite.mp3";
	dictionary["reached_favorite"] = tts ? "You are passing favourite" : "reached_favorite.mp3";
	...
	dictionary["speed_camera"] = tts ? "speed camera" : "speed_camera.mp3";
	dictionary["border_control"] = tts ? "border control" : "border_control.mp3";
	dictionary["railroad_crossing"] = tts ? "railway crossing" : "railroad_crossing.mp3";
	dictionary["traffic_calming"] = tts ? "speed bump" : "traffic_calming.mp3";
	dictionary["toll_booth"] = tts ? "toll barrier" : "toll_booth.mp3";
	dictionary["stop"] = tts ? "stop sign" : "stop.mp3";
	dictionary["pedestrian_crosswalk"] = tts ? "pedestrian crossing" : "pedestrian_crosswalk.mp3";
	...
	dictionary["toward"] = tts ? "towards" : "toward.mp3";

	// DISTANCE UNIT SUPPORT
	dictionary["meters"] = tts ? "metres" : "meters.mp3";
	dictionary["around_1_kilometer"] = tts ? "about 1 kilometre" : "around_1_kilometer.mp3";
	dictionary["around"] = tts ? "about" : "around.mp3";
	dictionary["kilometers"] = tts ? "kilometres" : "kilometers.mp3";
