...
function populateDictionary(tts) {
	// ROUTE CALCULATED
	dictionary["route_is"] = tts ? "Długość trasy to" : "route_is.mp3";
	dictionary["route_calculate"] = tts ? "Nowa trasa wyznaczona" : "route_calculate.mp3";
	dictionary["distance"] = tts ? "jej długość to" : "distance.mp3";

	// LEFT/RIGHT
	dictionary["after"] = tts ? "za" : "after.mp3";

	dictionary["left"] = tts ? "skręć w lewo" : "left.mp3";
	dictionary["left_sh"] = tts ? "skręć ostro w lewo" : "left_sh.mp3";
	dictionary["left_sl"] = tts ? "skręć lekko w lewo" : "left_sl.mp3";
	dictionary["right"] = tts ? "skręć w prawo" : "right.mp3";
	dictionary["right_sh"] = tts ? "skręć ostro w prawo" : "right_sh.mp3";
	dictionary["right_sl"] = tts ? "skręć lekko w prawo" : "right_sl.mp3";
	...
	dictionary["left_keep"] = tts ? "zajmij lewy pas" : "left_keep.mp3";
	dictionary["right_keep"] = tts ? "zajmij prawy pas" : "right_keep.mp3";
	dictionary["left_bear"] = tts ? "trzymaj się lewej strony" : "left_bear.mp3";    // in English the same as left_keep, may be different in other languages
	dictionary["right_bear"] = tts ? "trzymaj się prawej strony" : "right_bear.mp3";  // in English the same as right_keep, may be different in other languages

	// U-TURNS
	dictionary["make_uturn"] = tts ? "Zawróć" : "make_uturn.mp3";
	dictionary["make_uturn_wp"] = tts ? "Jeśli to możliwe, zawróć" : "make_uturn_wp.mp3";

	// ROUNDABOUTS
	dictionary["prepare_roundabout"] = tts ? "Przygotuj się do wjazdu na rondo" : "prepare_roundabout.mp3";
	dictionary["roundabout"] = tts ? "wjedź na rondo" : "roundabout.mp3";
	dictionary["then"] = tts ? "następnie" : "then.mp3";
	dictionary["and"] = tts ? "i" : "and.mp3";
	dictionary["take"] = tts ? "wybierz" : "take.mp3";
	dictionary["exit"] = tts ? "zjazd" : "exit.mp3";

	dictionary["1st"] = tts ? "pierwszy" : "1st.mp3";
	dictionary["2nd"] = tts ? "drugi" : "2nd.mp3";
	dictionary["3rd"] = tts ? "trzeci" : "3rd.mp3";
	dictionary["4th"] = tts ? "czwarty" : "4th.mp3";
	dictionary["5th"] = tts ? "piąty" : "5th.mp3";
	dictionary["6th"] = tts ? "szósty" : "6th.mp3";
	dictionary["7th"] = tts ? "siódmy" : "7th.mp3";
	dictionary["8th"] = tts ? "ósmy" : "8th.mp3";
	dictionary["9th"] = tts ? "dziewiąty" : "9th.mp3";
	dictionary["10th"] = tts ? "dziesiąty" : "10th.mp3";
	dictionary["11th"] = tts ? "jedenasty" : "11th.mp3";
	dictionary["12th"] = tts ? "dwunasty" : "12th.mp3";
	dictionary["13th"] = tts ? "trzynasty" : "13th.mp3";
	dictionary["14th"] = tts ? "czternasty" : "14th.mp3";
	dictionary["15th"] = tts ? "piętnasty" : "15th.mp3";
	dictionary["16th"] = tts ? "szesnasty" : "16th.mp3";
	dictionary["17th"] = tts ? "siedemnasty" : "17th.mp3";

	// STRAIGHT/FOLLOW
	dictionary["go_ahead"] = tts ? "Prosto" : "go_ahead.mp3";
	dictionary["follow"] = tts ? "Prosto przez" : "follow.mp3";

	// ARRIVE
	dictionary["and_arrive_destination"] = tts ? "następnie dotrzesz do celu podróży" : "and_arrive_destination.mp3";
	dictionary["reached_destination"] = tts ? "jesteś u celu podróży" : "reached_destination.mp3";
	dictionary["and_arrive_intermediate"] = tts ? "następnie dotrzesz do punktu pośredniego" : "and_arrive_intermediate.mp3";
	dictionary["reached_intermediate"] = tts ? "jesteś przy punkcie pośrednim" : "reached_intermediate.mp3";

	// NEARBY POINTS
	dictionary["and_arrive_waypoint"] = tts ? "następnie miniesz punkt GPX" : "and_arrive_waypoint.mp3";
	dictionary["reached_waypoint"] = tts ? "mijasz punkt GPX" : "reached_waypoint.mp3";
	dictionary["and_arrive_favorite"] = tts ? "następnie miniesz ulubiony punkt" : "and_arrive_favorite.mp3";
	dictionary["reached_favorite"] = tts ? "mijasz ulubiony punkt" : "reached_favorite.mp3";
	dictionary["and_arrive_poi"] = tts ? "następnie miniesz użyteczne miejsce" : "and_arrive_poi.mp3";
	dictionary["reached_poi"] = tts ? "mijasz użyteczne miejsce" : "reached_poi.mp3";

	// ATTENTION
	//dictionary["exceed_limit"] = tts ? "przekraczasz dozwoloną prędkość" : "exceed_limit.mp3";
	dictionary["exceed_limit"] = tts ? "ograniczenie prędkości do" : "exceed_limit.mp3";
	dictionary["attention"] = tts ? "uwaga" : "attention.mp3";
	dictionary["speed_camera"] = tts ? "fotoradar" : "speed_camera.mp3";
	dictionary["border_control"] = tts ? "kontrola graniczna" : "border_control.mp3";
	dictionary["railroad_crossing"] = tts ? "przejazd kolejowy" : "railroad_crossing.mp3";
	dictionary["traffic_calming"] = tts ? "próg zwalniający" : "traffic_calming.mp3";
	dictionary["toll_booth"] = tts ? "punkt pobierania opłat" : "toll_booth.mp3";
	dictionary["stop"] = tts ? "znak stop" : "stop.mp3";
	dictionary["pedestrian_crosswalk"] = tts ? "przejście dla pieszych" : "pedestrian_crosswalk.mp3";
	dictionary["tunnel"] = tts ? "tunel" : "tunnel.mp3";

	// OTHER PROMPTS
	dictionary["location_lost"] = tts ? "Utracono sygnał GPS" : "location_lost.mp3";
	dictionary["location_recovered"] = tts ? "Odzyskano sygnał GPS" : "location_recovered.mp3";
	dictionary["off_route"] = tts ? "znajdowałeś się poza trasą przez" : "off_route.mp3";
	dictionary["back_on_route"] = tts ? "wróciłeś na trasę" : "back_on_route.mp3";

	// STREET NAME PREPOSITIONS
	dictionary["onto"] = tts ? "w" : "onto.mp3";
	dictionary["on"] = tts ? "na" : "on.mp3";
	dictionary["to"] = tts ? "do" : "to.mp3";
	dictionary["toward"] = tts ? "w kierunku" : "toward.mp3";

	// DISTANCE UNIT SUPPORT
	// Some TTS engines get declinations right if abbreviated distance and time units are used.
	//dictionary["meters"] = tts ? "metrów" : "meters.mp3";
	dictionary["meters"] = tts ? "m" : "meters.mp3";
	dictionary["around_1_kilometer"] = tts ? "około jeden kilometr" : "around_1_kilometer.mp3";
	dictionary["around"] = tts ? "około" : "around.mp3";
	dictionary["kilometers"] = tts ? "kilometrów" : "kilometers.mp3";
	dictionary["kilometers_2-4"] = tts ? "kilometry" : "kilometers.mp3";

	dictionary["feet"] = tts ? "stóp" : "feet.mp3";
	dictionary["1_tenth_of_a_mile"] = tts ? "jedną dziesiątą mili" : "1_tenth_of_a_mile.mp3";
	dictionary["tenths_of_a_mile"] = tts ? "dziesiątych mili" : "tenths_of_a_mile.mp3";
	dictionary["around_1_mile"] = tts ? "około jedną milę" : "around_1_mile.mp3";
	dictionary["miles"] = tts ? "mil" : "miles.mp3";

	dictionary["yards"] = tts ? "jardów" : "yards.mp3";

	// TIME SUPPORT
	dictionary["time"] = tts ? ", przewidywany czas to" : "time.mp3";
	dictionary["1_hour"] = tts ? "jedna godzina" : "1_hour.mp3";
	dictionary["hours_2-4"] = tts ? "godziny" : "hours.mp3";
	dictionary["hours"] = tts ? "godzin" : "hours.mp3";

	dictionary["less_a_minute"] = tts ? "mniej niż minuta" : "less_a_minute.mp3";
	dictionary["1_minute"] = tts ? "jedna minuta" : "1_minute.mp3";
	dictionary["minutes_2-4"] = tts ? "minuty" : "minutes.mp3";
	dictionary["minutes"] = tts ? "minut" : "minutes.mp3";

	dictionary["2_f"] = tts ? "dwie" : "2.mp3";
}
